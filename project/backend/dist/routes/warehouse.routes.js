...
import { locationCreateSchema, locationUpdateSchema, warehouseCreateSchema, warehouseUpdateSchema, } from "../validators/warehouse.validators.js";
...
warehouseRouter.post("/:id/locations", validate(locationCreateSchema, "body"), warehouseController.createLocation);
