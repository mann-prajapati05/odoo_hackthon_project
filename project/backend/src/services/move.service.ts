...
import type { OperationType, Prisma, StockMoveDirection } from "@prisma/client";
...
const buildWhere = (query: MoveQuery): Prisma.StockMoveWhereInput => ({
...
export const moveService = {
  ...
  async exportCsv(query: MoveQuery, res: Response) {
    const where = buildWhere(query);
